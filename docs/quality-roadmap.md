...
| MCP remember `occurredAt` (unix secs or YYYY-MM-DD; landed `6f9d0b3`; tracker #4 closable) | medium | done | remem-mcp |
...
| Post-RRF multiplier rebalance: narrowed bands `0.9 + 0.1*` for importance and recency landed (`e844cd4`) | medium | done (code); success criterion NOT met (below) | remem-recall |
